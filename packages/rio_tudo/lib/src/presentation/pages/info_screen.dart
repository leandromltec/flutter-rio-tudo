...
import 'package:rio_tudo/src/presentation/pages/base_screen.dart';
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    Text(
                      'riotudo@gmail.com',
                    ).textInfoScreen(style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                    SizedBox(
                      width: 10,
                    ),
                    GestureDetector(
                           ...
                           Clipboard.setData(ClipboardData(text: 'teste'))
                              .then((value) => {
                                    ScaffoldMessenger.of(context).showSnackBar(
                                        SnackBar(content: Text('E-mail Copiado !')))
                                  });
                        },
